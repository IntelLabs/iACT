...
class Parser : public CodeCompletionHandler {
  ...
  OwningPtr<PragmaHandler> AxCHandler;
  OwningPtr<PragmaHandler> AxCMemoHandler;
  OwningPtr<PragmaHandler> AxCPrecisionHandler;
...
private:
  ...
  /// \brief Raj:: Parses axc declarative or executable directive.
  ///
  /// \param StandAloneAllowed true if allowed stand-alone directives,
  /// false - otherwise
  ///
  void ParseAxCDirective();
  void ParseAxCMemoDirective();
  void ParseAxCPrecisionDirective();
