...
public:
  ...
  /// Raj Approximate pragma information
  bool AxCOn;
  bool AxCPrecisionOn;
  void *AxCMemoize;
...
public:
  ...
  //Raj axc pragma
  void ActOnAxCDirective(const Token &Identifier,
                      Scope *curScope,
                      SourceLocation PragmaLoc);
  void ActOnAxCPrecisionDirective(const Token &Identifier,
                      Scope *curScope,
                      SourceLocation PragmaLoc);
  void ActOnAxCMemoDirective(const Token &Identifier,
                      Scope *curScope,
                      SourceLocation PragmaLoc ,
