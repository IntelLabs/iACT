...
Retry:
  ...
  case tok::annot_pragma_axc_precision:
	  fprintf(stderr, "Parsing axc_precision in ParseStatementOrDeclarationAfterAttributes\n");
	ParseAxCPrecisionDirective();
	return StmtEmpty();
#endif
  case tok::annot_pragma_axc_memo:
	  //fprintf(stderr, "Parsing axc_memo in ParseStatementOrDeclarationAfterAttributes\n");
    ParseAxCMemoDirective();
	return StmtEmpty();
#if 0
  case tok::annot_pragma_axc:
	  fprintf(stderr, "Parsing axc in ParseStatementOrDeclarationAfterAttributes\n");
    ParseAxCDirective();
	return StmtEmpty();
#endif
...
#if 0
	case tok::annot_pragma_axc_precision:
		fprintf(stderr, "Parsing axc_precision in ParseCompoundStatementLeadingPragmas\n");
      ParseAxCPrecisionDirective();
	  break;
#endif
    case tok::annot_pragma_axc_memo:
		fprintf(stderr, "Parsing axc_memo in ParseCompoundStatementLeadingPragmas\n");
	  ParseAxCMemoDirective();
	  break;
#if 0
	case tok::annot_pragma_axc:
		fprintf(stderr, "Parsing axc in ParseCompoundStatementLeadingPragmas\n");
      ParseAxCDirective();
	  break;
#endif
    default:
