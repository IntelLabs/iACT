...
/// Raj:  "\#pragma axc {function definition}
class PragmaAxCHandler : public PragmaHandler {
public:
  PragmaAxCHandler() : PragmaHandler("axc") { }
  virtual void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
                            Token &FirstToken);
};
/// Raj:  "\#pragma axc_memo callsite
class PragmaAxCMemoHandler : public PragmaHandler {
public:
  PragmaAxCMemoHandler() : PragmaHandler("axc_memoize") { }
  virtual void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
                            Token &FirstToken);
};
/// Raj:  "\#pragma axc_precision {function definition}
class PragmaAxCPrecisionHandler : public PragmaHandler {
public:
  PragmaAxCPrecisionHandler() : PragmaHandler("axc_precision_reduce") { }
  virtual void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
                            Token &FirstToken);
};
#if 0
class PragmaNoAxCHandler : public PragmaHandler {
public:
  PragmaNoAxCHandler() : PragmaHandler("axc") { }
  virtual void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
                            Token &FirstToken);
};
#endif
