...
Sema::BuildResolvedCallExpr(Expr *Fn, NamedDecl *NDecl,
 ...
 retry:
  ...
  /* Check if Sema object has AxCMemoizeIn and AxCMemoizeOut set or not */
  //Raj AxC propagation
  TheCall->AxCMemoize = NULL;
  if (AxCMemoize != NULL) {
		  //fprintf(stderr, "Attaching from Sema to CallExpr...\n");
		  TheCall->AxCMemoize = AxCMemoize;
		  AxCMemoize = NULL;
  }
