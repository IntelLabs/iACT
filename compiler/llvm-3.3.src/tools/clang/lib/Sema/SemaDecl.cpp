...
Sema::ActOnFunctionDeclarator(Scope *S, Declarator &D, DeclContext *DC,
  ...
  //Raj: add axc flags here to the FunctionDecl
  if(AxCOn) {
	  //fprintf(stderr, "Adding attribute AxC...\n");
	  NewFD->addAttr(::new (Context) AxCAttr(SourceLocation(), Context));
	  AxCOn = false;
  } else if (AxCPrecisionOn) {
	  //fprintf(stderr, "Adding attribute AxCPrecision...\n");
	   NewFD->addAttr(::new (Context) AxCPrecisionAttr(SourceLocation(), Context));
	  AxCPrecisionOn = false;
  }
