...
//Raj: AxC attribute
static void handleAxCAttr(Sema &S, Decl *D, const AttributeList &Attr) {
  // check the attribute arguments.
  if (!checkAttributeNumArgs(S, Attr, 0))
    return;
  ...
  D->addAttr(::new (S.Context)
             AxCAttr(Attr.getRange(), S.Context,
             Attr.getAttributeSpellingListIndex()));
}

//Raj: AxCPrecision attribute
static void handleAxCPrecisionAttr(Sema &S, Decl *D, const AttributeList &Attr) {
  // check the attribute arguments.
  if (!checkAttributeNumArgs(S, Attr, 0))
    return;
  ...
  D->addAttr(::new (S.Context)
             AxCPrecisionAttr(Attr.getRange(), S.Context,
             Attr.getAttributeSpellingListIndex()));
}
...
static void ProcessInheritableDeclAttr(Sema &S, Scope *scope, Decl *D,
  ...
  case AttributeList::AT_AnalyzerNoReturn:
	...
	// Raj::AxC attribute
  case AttributeList::AT_AxC:
    handleAxCAttr  (S, D, Attr); break;
	// Raj:: AxC Precision attribute
  case AttributeList::AT_AxCPrecision:
    handleAxCPrecisionAttr  (S, D, Attr); break;
