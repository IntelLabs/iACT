...
LLVMContext::LLVMContext() : pImpl(new LLVMContextImpl(*this)) {
  ...
  // Raj:: Create the 'axc_memoize' metadata kind.
  unsigned AxCMemoizeINID = getMDKindID("axc_memoize_in");
  assert(AxCMemoizeINID == MD_axc_memoize_in && "axc_memoize_in kind id drifted");
  (void)AxCMemoizeINID;

  // Raj:: Create the 'axc_memoize' metadata kind.
  unsigned AxCMemoizeOUTID = getMDKindID("axc_memoize_out");
  assert(AxCMemoizeOUTID == MD_axc_memoize_out && "axc_memoize_out kind id drifted");
  (void)AxCMemoizeOUTID;
