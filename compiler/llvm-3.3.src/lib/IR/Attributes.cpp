...
std::string Attribute::getAsString(bool InAttrGrp) const {
  ...
  //Raj:
  if (hasAttribute(Attribute::AxC))
    return "axc";
  //Raj
  if (hasAttribute(Attribute::AxCPrecision))
    return "axc_precision_reduce";
...
uint64_t AttributeImpl::getAttrMask(Attribute::AttrKind Val) {
  ...
  case Attribute::AxC:			   return 1ULL << 40; // precision reduction axc
  case Attribute::AxCPrecision:    return 1ULL << 41; // Raj: precision reduction axc
  }
